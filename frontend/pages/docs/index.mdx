...
`https://hntr.unlink.io/box/a822fd9e-9ec7-4d68-8e27-00f4259daeda`

To make this really simple to integrate into your toolchain, every container
can be filled (and exported from) over HTTP. 

`cat hostnames.txt | curl --data-binary @- "http://localhost:8080/api/box/a822fd9e-9ec7-4d68-8e27-00f4259daeda/hostnames"`
...
`cat domains.txt | curl --data-binary @- "https://hntr.unlink.io/api/box/f7a08ee9-6d28-4b3a-8364-526f77578003/hostnames?tags=root_scope"`
