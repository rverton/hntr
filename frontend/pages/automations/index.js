      ...
      <Layout>
        ...
        <div className="h-16 flex items-center border-b px-4 bg-white text-xl justify-between">
          ...
          <div className="flex space-x-2">
            ...
            <button onClick={() => setShowAdd(!showAdd)} type="submit" className="mt-3 w-full inline-flex items-center justify-center px-4 py-2 tracking-widest text-xs border border-transparent shadow-sm rounded-md text-white bg-orange-800 hover:bg-orange-900 sm:mt-0 sm:ml-3 sm:w-auto">
              Add
            </button>
          </div>
        </div>
